  ...
  return (
    <div>
        <div className="h-screen">
            ...
            <div className="text-xs text-gray position-fixed bottom-0 right-0">Please accept the certificate at <a href="https://192.168.2.234:8000">https://192.168.2.234:8000</a> if you face errors</div>
      </div>
    </div>
  )
}
