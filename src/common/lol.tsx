            ...
            <div className='flex flex-col items-center justify-center w-full'>
                ...
                <form className='flex flex-col items-center justify-center w-[300px]' onSubmit={(e) => {
                  ...
                  OnSubmit();}
                    ...
                    <input type="file" placeholder='Proof of Identity' className='border-2 border-gray-300 rounded-md p-2 my-2 w-full'
                    onChange={(e) =>{e.preventDefault(); selectFile(e)}} />
                    ...
                    onChange={(e) => {
                        e.preventDefault();
                        setData({...data, proof_of_address: e.target.files[0]})
                    }}
                    />
