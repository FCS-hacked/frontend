  ...
  console.log(props.product, "product")
   return (
    <div className="bg-white col-span-4 shadow-md px-3 py-3">
      <img src={props.product.image_url} alt="Product Image" height={200} width={200} className="mx-auto mb-3 h-[200px] w-auto"/>
      <div>
        ...
        <div className="grid grid-cols-12 gap-3 text-sm my-2">
          <div className="col-span-6">
            <span className="font-bold">Price:</span> {props.product.price}
          </div>
          <div className="col-span-6">
